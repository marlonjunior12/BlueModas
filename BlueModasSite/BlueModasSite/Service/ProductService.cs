...
namespace BlueModasSite.Service
{
    public class ProductService
    {
        ...
        {
            var response = await _httpClient.GetAsync("https://localhost:44395/api/produtos");
        ...
        {
            var response = await _httpClient.GetAsync($"https://localhost:44395/api/produtos/{id}");
            var result = await response.Content.ReadAsStringAsync();
